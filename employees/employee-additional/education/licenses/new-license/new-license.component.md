...
- **AgileHR**: `AgileHR/Talent/Talent.Web/ClientApp/src/app/employees/employee-additional/licenses/new-license/new-license.component.html`
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/licenses/new-license/new-license.component.html`
...
- Each `<settings-row>` contains different input components:
  - `<input-text>` for license name input.
...
The primary observation is that both files have identical markup structures and use the same components for license name, start date, and expiration date inputs.
...
![Mock Screen](new-license-mock.png)
