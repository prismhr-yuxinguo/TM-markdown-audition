...
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/certificates/certificates.component.html`
...
- Contains `<modal-base>` components for delete and new certificate modals with respective templates.
...
![Mock Screenshot](certificates-mock.png)
