...
- **AgileHR**: `AgileHR/Talent/Talent.Web/ClientApp/src/app/employees/employee-additional/driving-accidents/driving-accidents.component.html`
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/driving-accidents/driving-accidents.component.html`
...
- Contains `<modal-base>` components for delete and new driving accident modals with respective templates.
...
![Mock Screen](driving-accidents-mock.png)
