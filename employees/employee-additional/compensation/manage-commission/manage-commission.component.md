...
- **AgileHR**: `AgileHR/Talent/Talent.Web/ClientApp/src/app/employees/employee-additional/compensation/manage-commission/manage-commission.component.html`
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/compensation/manage-commission/manage-commission.component.html`
...
- Contains `<modal-base>` components for delete and new commission modals with respective templates.
...
![Mock Screenshot](manage-commission-mock.png)
