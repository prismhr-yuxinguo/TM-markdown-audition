...
- **AgileHR**: `AgileHR/Talent/Talent.Web/ClientApp/src/app/employees/employee-additional/compensation/manage-bonus/manage-bonus.component.html`
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/compensation/manage-bonus/manage-bonus.component.html`
...
- Contains `<modal-base>` components for delete and new bonus modals with respective templates.
...
![Mock Screenshot](manage-bonus-mock.png)
