...
- **AgileHR**: `AgileHR/Talent/Talent.Web/ClientApp/src/app/employees/employee-additional/compensation/manage-compensation/manage-compensation.component.html`
- **mocks-talent-ng**: `components-ng-shared/projects/mocks-talent-ng/src/app/employees/employee-additional/compensation/manage-compensation/manage-compensation.component.html`
...
- Contains `<modal-base>` components for delete and new compensation modals with respective templates.
...
![Mock Screenshots](manage-compensation-mock.png)
